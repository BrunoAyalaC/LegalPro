...
const USERS = {
  abogado:  { email: 'admin@legalpro.pe',    password: 'Demo2024!', rol: 'ABOGADO',   nombre: 'Admin' },
  fiscal:   { email: 'fiscal@legalpro.pe',   password: 'Demo2024!', rol: 'FISCAL',    nombre: 'Fiscal' },
  juez:     { email: 'juez@legalpro.pe',     password: 'Demo2024!', rol: 'JUEZ',      nombre: 'Juez' },
  contador: { email: 'contador@legalpro.pe', password: 'Demo2024!', rol: 'CONTADOR',  nombre: 'Contador' },
  demo:     { email: 'demo@legalpro.pe',     password: 'Demo2024!', rol: 'ABOGADO',   nombre: 'Demo' },
};

async function loginReal(page, user) {
  await page.goto('/login', { waitUntil: 'networkidle', timeout: 30000 });
  // Esperar que React renderice el formulario
  ...
  // Esperar navegación a dashboard o setup-org (hasta 30s para rate limit)
  try {
    await page.waitForURL(/dashboard|setup|onboarding|\/signup/i, { timeout: 30000 });
  } catch {
    console.log('URL after login:', page.url());
    throw new Error('Login redirect timeout. URL: ' + page.url());
  }
}
