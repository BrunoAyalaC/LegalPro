...
export default function BuscadorJurisprudencia() {
  useEffect(() => {
    document.title = 'Buscador de Jurisprudencia IA | LegalPro';
    ...
    metaDesc.setAttribute('content', 'Buscador jurisprudencial semántico de casaciones, amparos y precedentes vinculantes de la Corte Suprema y Tribunal Constitucional del Perú.');
  }, []);
