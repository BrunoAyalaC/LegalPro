...
export default function Expedientes() {
  ...
  const cargarExpedientes = () => {
    ...
    nodeClient.get('/api/expedientes', { params })
      .then(res => {
  ...
  useEffect(() => {
    document.title = 'Mis Expedientes Judiciales | LegalPro';
    ...
    metaDesc.setAttribute('content', 'Administra y organiza tus expedientes judiciales. Filtra por materias, controla plazos y prioridades, y accede a herramientas de IA.');
  }, []);
