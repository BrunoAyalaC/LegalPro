...
export default function AnalistaExpedientes() {
  ...
  useEffect(() => {
    if (expediente) {
      document.title = `Análisis de Expediente ${expediente.numero || expediente.id} | LegalPro`;
      ...
      metaDesc.setAttribute('content', `Consulta detalles, resume hechos, detecta plazos procesales y analiza la jurisprudencia asociada al expediente judicial N° ${expediente.numero || expediente.id} con ayuda de Lex-IA.`);
    }
  }, [expediente]);
