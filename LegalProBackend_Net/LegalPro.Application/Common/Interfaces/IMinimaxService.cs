...
/// <summary>
/// Core: cualquier prompt libre al proveedor IA (MiniMax M3 / OpenCode Go).
/// DEPRECATED (2026-08-06): nombre legacy "Gemini". Se conserva solo por
/// backward compatibility — renombrarlo rompería el build. Usar IMinimaxService.
/// </summary>
public interface IGeminiClient
{
    Task<string> GenerateAsync(string prompt, string model = "MiniMax-M3");
}
...
/// El proveedor IA (MiniMax M3 / OpenCode Go) actúa como la parte adversarial (Juez, Fiscal o Defensa).
