...
/// <summary>
/// Implementación fake de IMinimaxService para integration tests.
/// Retorna respuestas fijas deterministas para que los tests de MiniMax
/// corran SIEMPRE en CI/CD sin depender de la API real.
/// </summary>
public class FakeMinimaxService : IMinimaxService
{
    public Task<string> GenerateAsync(string prompt, string model = "MiniMax-M3")
